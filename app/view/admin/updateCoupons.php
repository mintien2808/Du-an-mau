...
<body>
    <div class="alert text-center title-login">
        <strong>Cập nhật mã giảm giá</strong>
    </div>
    <div class="sign-up col-md-12 col-md-offset-2 mt-10">
        <form class="sign-up__form" action="" method="post" >
            <div class="sign-up__content">
                <h2 class="sign-up__title">Cập nhật mã giảm giá</h2>

                <label for="code">Mã giảm giá:</label>
                <input class="sign-up__inp" id="code" type="text" name="code" placeholder="Nhập mã giảm giá">
                <?php if (isset($errors['code'])) echo "<p style='color:red;'>{$errors['code']}</p>"; ?>

                <label for="amount">Số tiền giảm:</label>
                <input class="sign-up__inp" id="amount" type="number" name="amount" placeholder="Nhập số tiền giảm">
            ...
            <div class="sign-up__buttons">
                ...
                <button class="btn btn--signin" type="submit">Cập Nhật Mã Giảm Giá</button>
            </div>
        </form>
    </div>
